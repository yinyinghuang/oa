...
class NotesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'desc' => ['type' => 'string', 'length' => 1000, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'start_time' => '2017-06-15 09:52:46',
            'end_time' => '2017-06-15 09:52:46',
            'created' => '2017-06-15 09:52:46',
            'modified' => '2017-06-15 09:52:46'
        ],
    ];
}
