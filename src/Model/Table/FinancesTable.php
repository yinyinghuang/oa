 ...
 * @property \Cake\ORM\Association\BelongsTo $FinanceTypes
 *
 * @method \App\Model\Entity\Finance get($primaryKey, $options = [])
 * @method \App\Model\Entity\Finance newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Finance[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Finance|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Finance patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Finance[] patchEntities($entities, array $data, array $options = [])
...
class FinancesTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['finance_type_id'], 'FinanceTypes'));
