...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'path' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'auth' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'lft' => 1,
            'rght' => 1,
            'created' => '2017-05-10 01:59:46',
            'modified' => '2017-05-10 01:59:46'
        ],
    ];
}
