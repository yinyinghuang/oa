...
/**
 * FinanceCustomersFixture
 *
 */
class FinanceCustomersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'receipt' => ['type' => 'string', 'length' => 1000, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'customer_id' => 1,
            'created' => '2017-05-22 10:46:26',
            'modified' => '2017-05-22 10:46:26'
        ],
    ];
}
