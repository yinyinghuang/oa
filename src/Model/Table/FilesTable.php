 ...
 * Files Model
 *
 * @property \Cake\ORM\Association\BelongsTo $ParentFiles
 * @property \Cake\ORM\Association\HasMany $Dropboxes
 * @property \Cake\ORM\Association\HasMany $ChildFiles
 *
...
class FilesTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['parent_id'], 'ParentFiles'));
